...
exports.SignUpHeader = withOverride_1.withOverride("EmailPasswordSignUpHeader", function EmailPasswordSignUpHeader(_a) {
    ...
    return react_1.jsx(
        react_2.Fragment,
        null,
        react_1.jsx("div", { "data-supertokens": "headerTitle", css: styles.headerTitle }, "Regístrate"),
        react_1.jsx(
            "div",
            ...
            react_1.jsx(
                ...
                "¿Ya tiene una cuenta?",
                react_1.jsx("span", { "data-supertokens": "link", onClick: onClick, css: styles.link }, "Inicia sesión")
            )
        ),
