...
exports.SignInHeader = withOverride_1.withOverride("EmailPasswordSignInHeader", function EmailPasswordSignInHeader(_a) {
    ...
    return react_1.jsx(
        react_2.Fragment,
        null,
        react_1.jsx("div", { "data-supertokens": "headerTitle", css: styles.headerTitle }, "Iniciar sesión"),
        react_1.jsx(
            "div",
            ...
            react_1.jsx(
                ...
                react_1.jsx("span", { "data-supertokens": "link", onClick: onClick, css: styles.link }, "Regístrate")
            )
        ),
